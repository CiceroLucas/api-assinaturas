...
<p>Example: <code>4326.41688</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>billing_cycle_in_days</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
 &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="billing_cycle_in_days"                data-endpoint="POSTapi-plans"
               value="16"
               data-component="body">
    <br>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="student_id"                data-endpoint="POSTapi-subscriptions"
               value="16"
               data-component="body">
    <br>
